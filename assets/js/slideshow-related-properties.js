document.addEventListener('DOMContentLoaded', function () {
  ...
  const propertyList = document.querySelector('.block.related.properties .content.slideshow--related-properties--wrapper .slideshow--related-properties .related-properties--list');

  if (propertyList) {
    const slideshowWrapper = document.createElement('div');
    slideshowWrapper.className = 'slideshow-properties--wrapper';

    const propertiesDiv = document.createElement('div');
    propertiesDiv.className = 'slideshow--related-properties--wrapper';
  ...
  setTimeout(() => {
    const slideshow = document.querySelector('.block.related.properties .content.slideshow--related-properties--wrapper .slideshow--related-properties .related-properties--list');
    if (!slideshow) return;
