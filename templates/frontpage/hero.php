<section id="hero" class="block site-hero">
    <video autoplay muted playsinline loop preload="metadata" role="presentation" id="video-on-hero" class="background-video-shortcode started" data-ratio="1.7777777777778" width="640" height="360">
        <source type="video/mp4" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/video/hero.mp4">
    </video>
    <div class="content text-white text-shadow">
        <div>
            ...
            <form action="">
                <input type="text">
                <button class="">BUSCAR CASA</button>
            </form>
            <div class="call-to-action">
                ...
                <button class="btn without-line go-to-properties text-white text-shadow" aria-label="Ve a la página de propiedades" onclick="window.location.href='<?php echo site_url(); ?>/propiedades'" aria-label="Botón para ver las propiedades">Ver propiedades<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-circle" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5z"></path></svg></button>
            </div>
        </div>
    </div>
</section>