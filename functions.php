 ...
 *
 * This file acts as the main "engine room" for the Inmobiliaria theme.
 * It handles:
 *  - Defining constants like the theme version.
 *  - Security measures to prevent direct access.
 *  - Loading optional theme components from the /inc directory (core, extended features, template helpers, EasyBroker integration).
 *
...
if ( ! defined( 'INMOBILIARIA_VERSION' ) ) {
    define( 'INMOBILIARIA_VERSION', (string) $version );
}
